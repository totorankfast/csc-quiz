...
public class Constant {
    ...
    public static String QUIZ_URL = "http://prcboardonline.atwebpages.com/api-v2.php";  //api url

    public static String FIREBASE_URL = "https://us-central1-prcboardonline-cc1e5.cloudfunctions.net/";/*FireBase function URL*/
    /////// PARAMETERS  ///////
